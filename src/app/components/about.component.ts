               ...
               <div class="container mx-auto p-4">
                <div class="grid grid-cols-2 gap-4">
                 <div class="col-span-1">
                     <h2 class="text-xl text-white mb-2">TypeScript</h2>
                     <h2 class="text-xl text-white mb-2">C# (.NET)</h2>
                     <h2 class="text-xl text-white mb-2">Angular</h2>
                 </div>
                 <div class="col-span-1">
                    <h2 class="text-xl text-white mb-2">React</h2>
                    <h2 class="text-xl text-white mb-2">JavaScript</h2>
                    <h2 class="text-xl text-white mb-2">PHP</h2>
                </div>
                 </div>
              </div>
             </div>
